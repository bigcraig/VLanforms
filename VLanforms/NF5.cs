...
namespace VLanforms
{
    public partial class NF5 : Form
    {
        ...
        bool checkLoginError(string html)
        {      // static since we dont need to instance another program class to run it

            string _pattern = "Password is wrong";
            Match match = Regex.Match(html, _pattern);
        ...
        void nf5Configuration(string PPPusername, string PPPpassword)
        {
         ...
         //  string cookieString = modem.Cookies.r
            ...
            configureModem.Text = "NF5 VLAN 100 PPPoE + ACS configured Successfully";

        }

        private Uri uri(string modemURL)
        {
